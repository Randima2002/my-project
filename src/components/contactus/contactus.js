            ...
            <section class="bg-gray-100">
                <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
                    <div class="max-w-2xl lg:max-w-4xl mx-auto text-center">
                        <h2 class="text-3xl font-extrabold text-gray-900">Touch With Us</h2>
                    ...
                    <div class="mt-16 lg:mt-20">
                        <div class="grid grid-cols-1 laptop:grid-cols-2 gap-8">
                            ...
                            <div>
                                <div class="max-w-full mx-auto rounded-lg overflow-hidden mt-4">
                                    <div class="px-6 py-4">
                                    ...
                                    <div class="border-t border-gray-200 px-6 py-4">
                                        ...
                                        <p class="mt-1 text-gray-600">Sample@gmail.com</p>
                                    </div>
                                    <div class="border-t border-gray-200 px-6 py-4">
